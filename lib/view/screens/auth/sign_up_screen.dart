...
import 'package:efood_multivendor/view/screens/auth/widget/CustomOtp.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  String _countryDialCode, verificationId;
  bool loading = false;
  ...
  Future<void> verifyPhone(
      SignUpBody signUpBody, AuthController authController) async {
    ...
    final PhoneCodeSent smsCodeSent =
      ...
      showDialog(
        ...
        if (valueFromDialog == 'success') {
          authController.adduser(signUpBody).then((status) async {
            if (status.isSuccess) {
              if (Get.find<SplashController>()
                ...
                // Get.toNamed(RouteHelper.getVerificationRoute(signUpBody.phone,
            ...
            child: Container(
              ...
              child: GetBuilder<AuthController>(builder: (authController) {
                return Column(children: [
                  ...
                  SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                  authController.isLoading && loading
  ...
  void _register(AuthController authController, String countryCode) async {
    ...
    if (_firstName.isEmpty) {
      ...
      authController.registration(signUpBody).then((status) async {
        if (status.isSuccess) {
          verifyPhone(signUpBody, authController);
        } else {
          showCustomSnackBar(status.message ?? 'Please try again');
        }
      });
    }
  }
